(function () {
    'use strict';
    (function (window) {
        var raf = 'requestAnimationFrame', caf = 'cancelAnimationFrame', v = ['ms', 'moz', 'webkit'], vl = v.length, af = 'AnimationFrame', lt = 0;
        ...
        if (!window[raf]) {
            window[raf] = function (callback) {
                var currTime = new Date().getTime(), timeToCall = Math.max(0, 16 - (currTime - lt)), id = window.setTimeout(function () {
            ...
            __vdom: function () {
                ...
                function updateElementProps(target, newProps, oldProps) {
                    ...
                    for (var name_3 in props) {
                        updateElementProp(target, name_3, newProps[name_3], oldProps[name_3]);
                    }
                }
                function setElementProps(target, props) {
                    for (var name_4 in props) {
                        prop(target, name_4, props[name_4], +1);
                    }
                }
