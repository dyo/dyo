...
n(t.routes,function(n){var e,r=n.callback,i=n.pattern,o=n.variables,a=t.url
if(e=a.match(RegExp(i))){var s=e.slice(1,e.length).reduce(function(t,n,e){return t||(t={}),t[o[e]]=n,t},null)
if(!r||r[c]!==Function)throw"could not find the render method"
r(s)}}.bind(this))}}}function a(t){var n,e=[],r=/(?:(^|#|\.)([^#\.\[\]]+))|(\[(.+?)(?:\s*=\s*("|'|)((?:\\["'\]]|.)*?)\5)?\])/g,i=t.props?t.props:{},o=t.type
...
var u={type:t,props:n,children:[],hs:!0};(-1!==u.type.indexOf("[")||-1!==u.type.indexOf("#")||-1!==u.type.indexOf("."))&&(u=a(u)),("svg"===u.type||"math"===u.type)&&(u.props.xmlns||(u.props.xmlns=f[u.type]))
for(var l=o;i>l;l++)if(e=r[l],e&&e[c]===Array)for(var d=0;d<e.length;d++)u.children[l-o+d]=s(e[d],u)
else u.children[l-o]=s(e,u)
return u}function l(){function t(n){if(!d){if(n.target!=a)return
a.style.transition=null,a.style.transform=null}a.style.transformOrigin=null,a.style.willChange=null,a.classList.remove("animation-running"),document.body.classList.remove("animation-running"),a.removeEventListener("transitionend",t)}for(var n,e,r,i,o,a,s,u,l,f,d,s=u=l=f={},n=Array.prototype.slice.call(arguments),p=n.length-1;p>=0;p--){var h=n[p]
...
return void 0!==n[e]&&n.namespaceURI!==f.svg&&(n[e]=r),"xlink:href"===e?n.setAttributeNS(f.xlink,"href",r):r!==f.svg&&r!==f.math?-1===i?n[o](e):n[o](e,r):void 0}}function a(t,n,e,r){void 0===e||null===e?o(t,n,r,-1):(void 0===r||null===r||e!==r)&&o(t,n,e,1)}function s(t,n,e){e=void 0!==e?e:{}
var r={}
...
var e
return e=t.props&&t.props.xmlns?document.createElementNS(t.props.xmlns,t.type):document.createElement(t.type),u(e,t.props),i(e,t.props),t.children&&t.children[c]===Array&&n(t.children.map(l),e.appendChild.bind(e)),e}function d(t,n){var e=t[c]!==n[c],r=t[c]===String&&t!==n,i=t.type!==n.type
...
setTimeout(function(){t.removeChild(i)},0)}else if(d(n,e))t.replaceChild(l(n),t.childNodes[r])
...
"POST"===n||"GET"===n?e.method=n:e.url=t}}),i(e)},mount:function(t,n){var e=this
if(n&&(e.parent=n),!e.parent)throw"the element to mount to does not exist"
e.parent.innerHTML="",e.vdom&&e.vdom.destroy(),e.vdom=this.__vdom(),e.vdom=new e.vdom(e.parent,t),e.vdom.init(),this.settings.loop&&e.vdom.auto(!0)},component:function(t){t.props=t.props||{},t.state=t.state||{}
var e=Object.create({setState:function(t){var e=this
n(t,function(t,n){e.state[n]=t})}}),e=function(){var e=this
n(t,function(t,n){"render"!==n&&t[c]===Function&&(t=t.bind(e)),e[n]=t})}
return n(["Props","State"],function(t){var r=t.toLowerCase()
e.prototype["set"+t]=function(t){var e=this
n(t,function(t,n){e[r][n]=t})}}),e=new e,e.__constructor&&e.__constructor(),function(t){return t&&n(t,function(t,n){e.props[n]=t}),e.render()}},createClass:function(t){return this.component(t)}},t(),window.h=u,window.animate=l,window.surl=o}()
