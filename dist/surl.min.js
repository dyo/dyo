...
e&&r.mount(e),r.settings={auto:!0},r.router={back:function(){history.back()},foward:function(){history.foward()},go:function(t){history.go(t)},destroy:function(){this.routes={},cancelAnimationFrame(this.raf.id)},nav:function(t){var n=this.settings.root
...
a&&(a=a.replace(/\\(["'])/g,"$1")),i[n[4]]=a||!0}return e.length>0&&(i["class"]=e.join(" ")),t.props=i,t}function s(t,n){return t&&t[d]===Object&&n.props.xmlns&&(t.props.xmlns=n.props.xmlns),(void 0===t||null===t||t[d]!==Object&&t[d]!==String&&t[d]!==Array)&&(t+="",("null"===t||"undefined"===t)&&(t="")),t}function u(t,n){var e,r=arguments,i=r.length,o=2
void 0!==n&&null!==n&&(n[d]===Object&&n.__hs||n[d]!==Object&&n[d]!==Function)?(o=1,n={}):(null===n||void 0===n||n[d]!==Object)&&(n={})
var u={type:t,props:n,children:[],__hs:!0};(-1!==u.type.indexOf("[")||-1!==u.type.indexOf("#")||-1!==u.type.indexOf("."))&&(u=a(u)),("svg"===u.type||"math"===u.type)&&(u.props.xmlns||(u.props.xmlns=f[u.type]))
for(var l=o;i>l;l++)if(e=r[l],e&&e[d]===Array)for(var c=0;c<e.length;c++)u.children[l-o+c]=s(e[c],u)
...
f||a.addEventListener("transitionend",t)}}function c(t){return{type:"p",props:{},children:[t],trust:!0,__hs:!0}}var d="constructor",f={math:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink"},p="getInitialState",h="getDefaultProps",m="componentWillMount",v="componentDidMount"
...
r.vdom&&(r.vdom.destroy(),r.vdom=void 0),r.parent.innerHTML="",t[m]&&t[m](e),r.vdom=this.__vdom(),r.vdom=new r.vdom(r.parent,t),r.vdom.init(),t[v]&&t[v](),r.settings.auto&&r.vdom.auto(!0)},component:function(n){n.props=n.props||{},n.state=n.state||{}
...
var r=new e
r[p]&&r.setState(r[p]()),r[h]&&r.setProps(r[h]())
var i=function(t,n){return n&&r.setProps({children:n}),t&&r.setProps(t),r.render()}
return r[m]&&(i[m]=r[m]),r[v]&&(i[v]=r[v]),i},createClass:function(t){return this.component(t)},createComponent:function(t){return this.component(t)}},function(){for(var t="requestAnimationFrame",n="cancelAnimationFrame",e=["ms","moz","webkit"],r=e.length,i="AnimationFrame",o=0,a=window,s=0;r>s&&!a[t];++s)a[t]=a[e[s]+"Request"+i],a[n]=a[e[s]+"Cancel"+i]||a[e[s]+"CancelRequest"+i]
a[t]||(a[t]=function(t){var n=(new Date).getTime(),e=Math.max(0,16-(n-o)),r=a.setTimeout(function(){t(n+e)},e)
return o=n+e,r}),a[n]||(a[n]=function(t){clearTimeout(t)})}(),window.h=u,window.bind=o,window.trust=c,window.animate=l,window.surl=i}()
