...
n(t[0],t[1])}},l&&(r.withCredentials=!0),"GET"!==a&&r.setRequestHeader("Content-Type",t.data&&t.data[d]===Object?"application/json":"text/plain"),"POST"===a?(r.setRequestHeader("Content-type","application/x-www-form-urlencoded"),r.send(e(t))):r.send(),r}function i(e){var r=this
e&&r.mount(e),r.settings={loop:!0},r.router={back:function(){history.back()},foward:function(){history.foward()},go:function(t){history.go(t)},destroy:function(){this.routes={},cancelAnimationFrame(this.raf.id)},nav:function(t){var n=this.settings.root
...
i.cmp?r.render(i,void 0,s):i(s)}})}}}function o(t,n,e){return function(){var r=this,i=t in r?r[t]:r.getAttribute(t)
void 0!==i&&null!==i&&(n[e]=i)}}function a(t){var n,e=[],r=/(?:(^|#|\.)([^#\.\[\]]+))|(\[(.+?)(?:\s*=\s*("|'|)((?:\\["'\]]|.)*?)\5)?\])/g,i=t.props?t.props:{},o=t.type
for(t.type="div";n=r.exec(o);)if(""===n[1]&&n[2])t.type=n[2]
else if("#"===n[1])i.id=n[2]
else if("."===n[1])e.push(n[2])
else if("["===n[3][0]){var a=n[6]
a&&(a=a.replace(/\\(["'])/g,"$1")),i[n[4]]=a||!0}return e.length>0&&(i["class"]=e.join(" ")),t.props=i,t}function s(t,n){return t&&t[d]===Object&&n.props.xmlns&&(t.props.xmlns=n.props.xmlns),(void 0===t||null===t||t[d]!==Object&&t[d]!==String&&t[d]!==Array)&&(t+="",("null"===t||"undefined"===t)&&(t="")),t}function l(t,n){var e,r=arguments,i=r.length,o=2
...
for(var u=o;i>u;u++)if(e=r[u],e&&e[d]===Array)for(var c=0;c<e.length;c++)l.children[u-o+c]=s(e[c],l)
else l.children[u-o]=s(e,l)
return l}function u(){function t(n){if(!f){if(n.target!=a)return
a.style.transition=null,a.style.transform=null}a.style.transformOrigin=null,a.style.willChange=null,a.classList.remove("animation-running"),document.body.classList.remove("animation-running"),a.removeEventListener("transitionend",t)}for(var n,e,r,i,o,a,s,l,u,c,f,s=l=u=c={},n=Array.prototype.slice.call(arguments),p=n.length-1;p>=0;p--){var h=n[p]
h[d]===Array?i=h.join(" "):h[d]===Number?r=h:h[d]===String?-1!==h.indexOf(",")?o=h:e=h:h.target&&(a=h.target)}if(this[d]===Number?r=this:this[d]===String?e=this:e||(e="animation-active"),e&&a){if(a.style.willChange="transform",s=a.getBoundingClientRect(),a.classList.toggle(e),l=a.getBoundingClientRect(),u.x=s.left-l.left,u.y=s.top-l.top,u.sx=s.width/l.width,u.sy=s.height/l.height,a.animate&&a.animate[d]===Function)var f=!0
...
m.addEventListener("finish",t)}else a.style.transform=c.first,a.offsetWidth,a.style.transition="transform "+c.duration+"ms "+c.easing,a.style.transform=c.last
f||a.addEventListener("transitionend",t)}}function c(t){return{type:"p",props:{},children:[t],trust:!0,__hs:!0}}var d="constructor",f={math:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink"}
...
for(var i in r)a(t,i,n[i],e[i])}function l(t,n){for(var e in n)o(t,e,n[e],1)}function u(n){if(n[d]===String)return document.createTextNode(n)
if(!n.__hs)return document.createTextNode(JSON.stringify(n))
...
return a=n.props&&n.props.xmlns?document.createElementNS(n.props.xmlns,n.type):document.createElement(n.type),l(a,n.props),i(a,n.props),n.children&&n.children[d]===Array&&t(n.children.map(u),a.appendChild.bind(a)),a}function c(t,n){var e=t[d]!==n[d],r=t[d]===String&&t!==n,i=t.type!==n.type
...
setTimeout(function(){t.removeChild(i)},0)}else if(c(n,e))t.replaceChild(u(n),t.childNodes[r])
...
h(this.parent,t,n),this.old=t},init:function(){this.old=this.render(),h(this.parent,this.old)},destroy:function(){this.auto(!1),this.old=void 0,this.render=void 0,this.raf=void 0,this.parent=void 0},auto:function(t){var e=this
return t?(e.raf={id:1},void n(function(){e.update()},60,e.raf)):(cancelAnimationFrame(e.raf.id),e.raf.id)}},m},req:function(){var n=arguments,e={method:"GET"}
...
r.vdom&&(r.vdom.destroy(),r.vdom=void 0),r.parent.innerHTML="",t.componentWillMount&&t.componentWillMount(e),r.vdom=this.__vdom(),r.vdom=new r.vdom(r.parent,t),r.vdom.init(),r.settings.loop&&r.vdom.auto(!0)},component:function(n){n.props=n.props||{},n.state=n.state||{}
var e=function(){var e=this
t(n,function(t,n){t[d]===Function&&(t=t.bind(e)),e[n]=t})}
t(["Props","State"],function(n){var r=n.toLowerCase()
e.prototype["set"+n]=function(n){var e=this
n&&t(n,function(t,n){e[r][n]=t})}})
var r=new e
r.getInitialState&&r.setState(r.getInitialState()),r.getDefaultProps&&r.setProps(r.getDefaultProps())
var i=function(t,n){return n&&r.setProps({children:n}),t&&r.setProps(t),r.render()}
return r.componentWillMount&&(i.componentWillMount=r.componentWillMount),i.cmp=!0,i},createClass:function(t){return this.component(t)},createComponent:function(t){return this.component(t)}},function(){for(var t="requestAnimationFrame",n="cancelAnimationFrame",e=["ms","moz","webkit"],r=e.length,i="AnimationFrame",o=0,a=window,s=0;r>s&&!a[t];++s)a[t]=a[e[s]+"Request"+i],a[n]=a[e[s]+"Cancel"+i]||a[e[s]+"CancelRequest"+i]
a[t]||(a[t]=function(t){var n=(new Date).getTime(),e=Math.max(0,16-(n-o)),r=a.setTimeout(function(){t(n+e)},e)
return o=n+e,r}),a[n]||(a[n]=function(t){clearTimeout(t)})}(),window.h=l,window.bind=o,window.trust=c,window.animate=u,window.surl=i}()
