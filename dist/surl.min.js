...
f||a.addEventListener("transitionend",t)}}var d="constructor",f={math:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink"},p="getInitialState",h="getDefaultProps",m="componentWillMount",v="componentDidMount"
...
r.settings.auto&&r.vdom&&r.vdom.destroy(),r.parent.innerHTML="",t[m]&&t[m](e),r.vdom=this.__vdom(),r.vdom=new r.vdom(r.parent,t),r.vdom.init(),t[v]&&t[v](),r.settings.auto&&r.vdom.auto(!0)},component:function(n){var e=this
...
return i[m]&&(o[m]=i[m]),i[v]&&(o[v]=i[v]),o},createClass:function(t){return this.component(t)},createComponent:function(t){return this.component(t)}},function(){for(var t="requestAnimationFrame",n="cancelAnimationFrame",e=["ms","moz","webkit"],r=e.length,i="AnimationFrame",o=0,a=window,s=0;r>s&&!a[t];++s)a[t]=a[e[s]+"Request"+i],a[n]=a[e[s]+"Cancel"+i]||a[e[s]+"CancelRequest"+i]
