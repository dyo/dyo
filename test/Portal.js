...
describe('Portal', () => {
	...
	it('should remove from the head of a portal', () => {
		render(h('div', {}, createPortal([], portal, 1)), target, (current) => {
	...
	it('should create a portal with a single child', () => {
		render(h('div', {}, createPortal(h('h1', {key: 1}, 1), portal, 1)), target, (current) => {
			assert.html(parent, '<main><div></div></main><aside><h1>1</h1></aside>')
		})
	})
	...
	it('should render a nested portal', () => {
		render(h('div', {}, h('h1', {key: 0}, 0), createPortal([
			h('h1', {key: 1}, 1), createPortal([h('h1', {key: 2}, 2)], portal, 2)
		], portal, 1)), target, (current) => {
	...
	it('should render a portal selector', () => {
		render(h('div', {}, createPortal(h('h1', {key: 1}, 1), 'aside', 1)), target, (current) => {
			assert.html(parent, '<main><div></div></main><aside><h1>1</h1></aside>')
		})
	})
	...
	it('should reparent a portal', () => {
		...
		render(h('div', {}, createPortal(h('h1', {key: 1}, 1), 'main', 1)), target, (current) => {
