(function (root, factory) {
	 ...
	 * define tests
	 */
	function tests (test, h, dio, document) {
		...
		test('dio.createRender', function (ok, eq, spy, end) {
			...
			ok(eq(getHScriptFromRender, hyperscript), "render(__, __, '@@dio/HYPERSCRIPT')");
	 ...
	 */
	// NODE_ENV
	if (typeof require === 'function' && require !== exports.require) {
		var 
		dio   = require('../dio.js'),
	...
	// BROWSER_ENV
		...
		tests(root.test, root.h, root.dio);
	}
}));